            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="flex items-center">
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="{{ route('donasi-create') }}"
                                   class="underline text-gray-900 dark:text-white">Rencana Donasi</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="{{ route('bencana-create') }}"
                                   class="underline text-gray-900 dark:text-white">Tambah Kejadian Bencana</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="{{ route('logistik-create') }}"
                                   class="underline text-gray-900 dark:text-white">Catat Jumlah Pengungsi</a>
                            </div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="{{ route('logistik-kelola') }}"
                                   class="underline text-gray-900 dark:text-white">Kelola Logistik</a>
                            </div>
                        </div>
